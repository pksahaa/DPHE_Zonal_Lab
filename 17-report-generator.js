...
function CustomReportGeneratorPage({
  ...
  React.useEffect(() => {
    ...
    const sentByVals = unique(selectedSamples.map(s => s.clientName));
  ...
  }, [["memoNo", "Memo No"], ["date", "Date", "date"], ["sentBy", "Sent by"], ["district", "District"], ["sampleSource", "Sample Source (e.g. STW-6)"], ["refMemoNo", "Ref: Memo No"], ["refMemoDate", "Ref: Memo Date"], ["dateOfTesting", "Date of Testing"], ["collectionDate", "Collection Date"], ["receivingDate", "Receiving Date"]].map(([key, label, type]) => /*#__PURE__*/React.createElement(TextField, {
    key: key,
    simple: true,
    label: label,
    type: type || "text",
